...
namespace fleetBattle
{
  game::game( std::shared_ptr<command_t> commandPtr,
              ...
              deployedShips_t deployedB)  :   playerA(new player( std::shared_ptr<fleetBattle::playerBoard>(new fleetBattle::playerBoard(deployedA)),
                                              ...
                                              agentA(new agent('A',std::make_shared<playerInTurn_t>(mm->playerInTurn_public),mA,commandPtr)),
                                              agentB(new agent('B',std::make_shared<playerInTurn_t>(mm->playerInTurn_public),mB,commandPtr))
  {}
  game::~game(){}
}